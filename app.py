...
layout_index = html.Div([
    html.Table([
        ...
        html.Th(dcc.Link('Price Predictor', href='/page-5'),style={'text-align': 'center'}),
        html.Th(dcc.Link('Results', href='/page-6'),style={'text-align': 'center'}),
       ])]),
    html.Div(html.Img(src=app.get_asset_url('hpp1.png')), style={'textAlign': 'left'}),
])
#-----------------------------------------page1-Data----------------------------------------------------------------------
